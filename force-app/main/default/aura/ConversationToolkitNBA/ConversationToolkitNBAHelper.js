({
    ...
    invokeNBA: function(cmp, transcriptText, vcRecordId) {
        var transcriptVariable = {ConversationKey: transcriptText, VoiceCallId: vcRecordId};
        ...
        for (var i=0; i < helperList.length; i++){
            ...
            if (transcriptLower.includes(helperItemLower)){
                if ((speaker == 'EndUser' && helperItem.Customer__c == true) || (speaker == 'Agent' && helperItem.Agent__c == true)){
                    ...
                    this.invokeNBA(cmp, helperItem.OM_Family__c, vcId );
                    break;
                }         
            }
        }
